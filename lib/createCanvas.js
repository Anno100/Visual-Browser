...
const createCanvas = (width=100, height=100, p_id = 'canvas_'+canvas_id++) => {
    ...
    ret.c.addEventListener('touchstart',()=>{ret.Mouse.down = true;console.log("Ja")});
    ret.c.addEventListener('touchend',()=>{ret.Mouse.down = false;console.log("Nein");window.alert("Nein")});
